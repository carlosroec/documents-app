...
module.exports = function(app) {
	...
	// Create endpoint /api/documents for POSTS
	app.post('/api/documents', function(req, res) {
		...
		if ( (!req.body.hasOwnProperty('author')) || (!req.body.hasOwnProperty('contents')) || (!req.body.hasOwnProperty('published')) ) {
			res.statusCode = 400;
	...
	app.get('/api/documents/:document_id', function(req, res) {
	...
	app.put('/api/documents/:document_id', function(req, res) {
